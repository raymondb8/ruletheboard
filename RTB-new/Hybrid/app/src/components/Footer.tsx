...
export default function Footer() {
  return (
    <footer className="w-full py-12 px-margin-mobile md:px-margin-desktop flex flex-col items-center gap-base bg-surface-sunken border-t border-outline-variant">
      <div className="max-w-container-max w-full flex flex-col gap-8 mb-10">
        ...
        {/* Instagram + email, centered in the footer, with the handles spelled
            out in text. Both marks sit in the same 36px bordered badge. */}
        <div className="self-center flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
          <a
